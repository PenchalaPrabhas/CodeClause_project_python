...
import winsound
clock = Tk()
clock.configure(background="pink")
...
addTime = Label(clock,text = "Hour  Min   Sec",font=60 , fg="white", bg="black").place(x = 110)
...
submit = Button(clock,text = "Set Alarm",fg="black",width = 10,command = actual_time).place(x =160,y=70)
clock.mainloop()
